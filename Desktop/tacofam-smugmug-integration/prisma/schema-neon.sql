...
CREATE TABLE IF NOT EXISTS users (
    ...
    coin_balance INTEGER DEFAULT 10000,
...
CREATE TABLE IF NOT EXISTS coin_transactions (
    ...
    related_ai_operation_id INTEGER,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
-- Create default admin user (you'll need to update the password hash)
INSERT INTO users (email, password_hash, name, role, coin_balance)
VALUES (
    'admin@smugmugtoolbox.com',
    '$2a$10$rKZqJqYJxQYxJxQYxJxQYu3nYqGqGqGqGqGqGqGqGqGqGqGqGqGqG',
    'Admin User',
    'admin',
    999999999
)
